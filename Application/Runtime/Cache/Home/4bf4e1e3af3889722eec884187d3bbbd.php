...
<head>
    ...
    <title>关于我们</title>
    <meta name="keywords" content="西安哪里有网站维护，西安网站优化，西安网站制作，西安做网站，西安做网页，西安网页制作，西安网站开发，西安企业网站制作，西安网页设计" />
    <meta name="description" content="西安腾诺网络致力于互联网品牌建设与网络营销，专业领域包括网站建设、电子商务、移动互联网营销、系统平台开发等服务范围， 并且涵盖基础的域名服务、主机服务；企业邮箱、网络营销等应用服务" />
...
<div class="abou">
    <div class="abou1">
        <div class="abou2">
            <img src="/Public/Home/images/about_02.png" alt="西安小程序开发">
        </div>
        <div class="abou3">
            <h3><?php echo ($about_list["title"]); ?></h3>
            <div class="abou4">
                <?php echo ($about_list["content"]); ?></p>
            </div>
        </div>
    </div>
</div>
...
<div class="abi">
    <div class="abi1">
        <h3>企业文化</h3>
        <p>我们敢想、敢做、敢创新，我们深知尺有所短、寸有所长，<br>
            但我们敢于变化，专注于互联网产品的创新，以最新的理念帮助您完善产品，我们秉承与客户双赢的理念，您的产品，也是我们的产品。</p>

        <div class="abi2">
            <ul>
			   <?php if(is_array($res)): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><img src="/Public/<?php echo ($vo["imgpath"]); ?>" alt="西安网站建设"></li><?php endforeach; endif; else: echo "" ;endif; ?> 
            </ul>
        </div>
    </div>
</div>
...
<div class="gd">
    <div class="gd1">
        <h3>公司动态</h3>
        <div class="gd2">
		    <?php if(is_array($ress)): $i = 0; $__LIST__ = $ress;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="gd3">
                <div class="gd4">
                    <a href="/newsinfo-id-<?php echo ($vo['id']); ?>.html">
                        <div class="gd5"><img src="/Public/<?php echo ($vo["imgpath"]); ?>" alt="西安网站制作"></div>
                        <div class="gd6">
